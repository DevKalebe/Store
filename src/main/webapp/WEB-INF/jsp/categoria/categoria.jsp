                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            ...
                            <button title="Excluir" onclick="window.location.href='deleteCategory/${categoria.id}'" class="btn btn-danger" type="button">
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © Deiny Board 2022</div>
