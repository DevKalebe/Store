...
<html lang="pt-br">
    ...
    <body id="page-top">
        ...
        <header class="masthead" id="login">
            <div class="container">
                <div class="masthead-subheading">Bem Vindo ao SenaiCommerce!</div>
                ...
                <form method="post" action="<c:url value="/login/autenticarUser"/>">
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input class="form-control" id="email" name="email" value="${email}" type="email" placeholder="Email *"  data-validation-required-message="Please enter your email address." required="required" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group mb-md-0 input-login mx-auto">
                                <input class="form-control" id="senha" name="senha" value="${senha}" type="password" placeholder="Senha *"   data-validation-required-message="Insira sua senha." required="required" />
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                         
                    </div>
                    <button class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" type="submit">Login</button>
                </form>
        ...
        <section class="page-section" id="beneficios">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Aqui na SenaiCommerce voc̻ encontra os melhores pre̤os!</h3>
                </div>
