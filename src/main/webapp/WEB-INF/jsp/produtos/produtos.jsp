...
<head>
  ...
  <title>Deiny Board | Produtos</title>
        ...
        <div class="col-lg-3 col-sm-6 mb-3">
          <div class="portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal${product.id }">
              ...
              <img class="img-fluid" src="img/get/${product.imageProduct.nome}" alt="" />
            </a>
            <div class="portfolio-caption">
              <div class="portfolio-caption-heading">${product.valueMoney}</div>
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    <div class="modal-body">
                      ...
                      <img class="img-fluid d-block mx-auto img-modal" src="img/get/${product.imageProduct.nome}" alt="" />
                      <h2 class="text-uppercase">${product.valueMoney}</h2>
                      ...
                      <ul class="list-inline">
                        <li>Promoção valida Até: ${product.dateFormat}</li>                     
                      </ul>
